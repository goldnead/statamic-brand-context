 ...
 * addons installable outside the host they were written for, and it is covered
 * by a test of its own in every one of them.
 *
 ...
 * wrong place: the digest builder stamps `digested_at` before the mail leaves,
 * so a typo discovered at delivery time costs every recipient their week of
 * items with nothing sent.
 */
